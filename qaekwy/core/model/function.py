...
def power(expr: Expression, exponent: int) -> Expression:
    """
    Returns an expression representing the exponentiation of an expression by a exponent.
    ...
    return Expression(f"(pow({expr}, {exponent}))")
