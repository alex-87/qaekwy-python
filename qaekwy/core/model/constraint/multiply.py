...
class ConstraintMultiply(AbstractConstraint):
    ...
    Args:
        var_1: The first factor.
        var_2: The second factor.
        var_3: The product.
    ...
    Example:
        ...
        >>> constraint = ConstraintMultiply(x, y, z)
    """

    def __init__(
        self, var_1: Variable, var_2: Variable, var_3: Variable, constraint_name=None
    ) -> None:
        """Initializes a new multiplication constraint.
    ...
    @staticmethod
    def from_json(json_data: dict, variables: list) -> "ConstraintMultiply":
        """Creates a ConstraintMultiply instance from a JSON object.
        ...
        Returns:
            An instance of the ConstraintMultiply class.
        """
        ...
        return ConstraintMultiply(var1, var2, var3, json_data.get("name"))
