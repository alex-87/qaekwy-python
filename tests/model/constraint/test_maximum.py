...
class TestConstraintMaximum(unittest.TestCase):
    ...
    def test_constraint_creation(self):
        constraint = ConstraintMaximum(self.variable_1, self.variable_2, self.variable_3, "max_constraint")
        self.assertEqual(constraint.var_1, self.variable_1)
        self.assertEqual(constraint.var_2, self.variable_2)
        self.assertEqual(constraint.var_2, self.variable_3)
        self.assertEqual(constraint.constraint_name, "max_constraint")
